...
import com.smartificials.aida.databinding.ActivityChoresBinding;
...
public class ChoresActivity extends BaseActivity<ActivityChoresBinding, ChoresViewModel> implements ChoresNavigator {


    private ActivityChoresBinding mActivityChoresBinding;

    public static Intent newIntent(Context context) {
        return new Intent(context, ChoresActivity.class);
    }
    ...
    public int getLayoutId() {
        return R.layout.activity_chores;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mActivityChoresBinding=getViewDataBinding();
